...
<body>
    <header>
        <a href="./www/index.php" class="back_btn"  id="customer_back_btn"><i class="fa-solid fa-chevron-left"></i>Back</a>
    </header>
    <main>
            ...
            <div class="registration__right">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  method="POST" enctype="multipart/form-data" class="registration__form" id="form_1">
                    ...
                    <div class="form_field">
                        ...
                        <input type="text" class="form_field__input" id="password" placeholder="Enter password" name="password">
                        <span class="form_field__message">
                    ...
                    <div class="form_field">
                        ...
                        <input type="text" class="form_field__input" id="name" placeholder="Enter your name" name="name">
                        <span class="form_field__message">
                    ...
                    <div class="form_field">
                        ...
                        <input type="text" class="form_field__input" id="address" placeholder="Enter your address" name="address">
                        <span class="form_field__message"></span>
                    </div>

                    <div class="form_field">
                        <input type="submit" class="form_field__label btn-hover color-9" id="submit_btn" name="submit_btn" value="Register">
                    </div>
